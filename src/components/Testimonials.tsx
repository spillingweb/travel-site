...
const Testimonials: React.FC = () => {
  return (
    <section id="testimonials" className="page-section page-section--testimonials">
      <Wrapper className="wrapper--no-padding-until-medium">
        ...
        <Row className="row--equal-height-at-large row--gutters-small row--t-padding generic-content-container">
